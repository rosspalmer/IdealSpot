...
For sailing we want about 20 m/s, a temperature of ~295K (22C),
...
target = IdealWindTarget(target, 'wind_day_one', start_time_first_day, end_time_first_day, 20.0)
target = IdealWindTarget(target, 'wind_day_two', start_time_second_day, end_time_second_day, 20.0)
...
for spot in spots:
    print('%s score: %s' % (spot.get_name(), spot.get_overall_score()))
